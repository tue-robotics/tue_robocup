...
class Amigo(robot.Robot):
    ...
    def __init__(self, dontInclude=None, wait_services=False):
        ...
        self.add_arm_part('leftArm', arms.Arm(self.robot_name, self.tf_listener, self.joint_states, side="left"))
        self.add_arm_part('rightArm', arms.Arm(self.robot_name, self.tf_listener, self.joint_states, side="right"))
