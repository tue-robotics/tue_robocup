...
while not rospy.is_shutdown():
    ...
    if gd.detect():
        print("robot is currently holding something!!! , ", "Last measured torque_y: {}".format(gd.msg_list[-1]))
    else:
        print("Not holding anything :( , ", "Last measured torque_y: {}".format(gd.msg_list[-1]))
