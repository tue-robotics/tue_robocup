...
{'category': 'food', 			'placement': 'kitchencounter', 	'group': 'known', 		'sub-category':'',		'name': 'coco_balls'}, 
{'category': 'food', 			'placement': 'kitchencounter', 	'group': 'known', 		'sub-category':'',		'name': 'egg_stars'},
