...
locations = [
    ...
    {'name': 'left_arm_chair',  'room': 'living_room',      'category': 'utility',      'manipulation': 'no'},
    {'name': 'right_arm_chair', 'room': 'living_room',      'category': 'utility',      'manipulation': 'no'},
    ...
    {'name': 'storage_shelf',   'room': 'bar',              'category': 'shelf',        'manipulation': 'yes'},
