...
#         ((((<2_action_person> <2_person>)|(<2_action> ((the <2_objects_plural>)|(an <2_objects_aeuoi>)|(a <2_objects_rest_singular>))))
#             (and (<3_action_person>|(<3_action> (them|it|) to (the <3_location>|<3_person>)))))
# 		|((<2_action_count> the <2_objects_types_plural>) and (<3_action_report> to <3_person>))))"""
...
spec23_1 = "((<2_action> ((the <2_objects_plural>)|(an <2_objects_aeuoi>)|(a <2_objects_rest_singular>))) and <3_action> (them|it|) to (the <3_location>|<3_person>))"
...
choices = {"1_action":["go","navigate","move","advance"],
 ...
 # "2_objects_aeuoi":objects_aeuoi,
 # "2_objects_rest_singular":objects_rest + object_types_singular,
 # "3_action_person":["tell the time", "follow her","follow him"],
 # "3_action":["take","move","bring"],
 # "3_location":locations + rooms,
 # "3_action_report":["report"],
 # "3_person":persons}
