...
manipulation_location = {'water' : 'bar',  
                         'biscuits' : 'sideboard', 
                         'energy_drink' : 'bar'} 
default_search_location = 'bar'#If no location is defined for an object here, the default is $default_search_location
