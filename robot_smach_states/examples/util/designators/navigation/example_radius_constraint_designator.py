...
# Robot Smach States
from robot_smach_states.util.designators.navigation.radius_constraints import RadiusConstraintsDesignator
...
if __name__ == "__main__":
    ...
    nav1 = RadiusConstraintsDesignator(entity, 1.2, name="radius designator")
