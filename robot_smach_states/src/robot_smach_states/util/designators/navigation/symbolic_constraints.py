...
class SymbolicConstraintsDesignator(NavigationConstraintsDesignator):
    ...
    """
    def __init__(self, robot, entity_designator_area_name_map, entity_lookat_designator, name=None):
...
class RoomConstraintsDesignator(SymbolicConstraintsDesignator):
    def __init__(self, robot, entity_designator_room, entity_lookat_designator=None):
        ...
        super(RoomConstraintsDesignator, self).__init__(robot, {entity_designator_room: room_area}, entity_lookat_designator)
