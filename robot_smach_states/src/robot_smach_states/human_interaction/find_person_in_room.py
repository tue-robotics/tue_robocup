...
class FindPerson(smach.State):
    ...
    def __init__(self, robot, person_label, _timeout=60.0, look_distance=2.0):
    ...
    def execute(self, userdata=None):
        ...
        while (rospy.Time.now() - start_time).to_sec() < self._timeout:
            ...
            best_detection = self._robot.perception.get_best_face_recognition(raw_detections, self._person_label)
