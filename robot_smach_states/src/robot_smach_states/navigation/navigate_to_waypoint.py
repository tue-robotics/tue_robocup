...
class NavigateToWaypoint(NavigateTo):
    ...
    def generateConstraint(self):
        ...
        if not e:
            rospy.logerr("NavigateToWaypoint::generateConstraint: No entity could be resolved from"
                         "designator '%s'" % self.waypoint_designator)
            return None
        ...
        if self.look_at_designator:
            ...
            if look_at_e:
                ...
                rospy.logerr("NavigateToWaypoint::generateConstraint: No entity could be resolved from"
                             "designator '%s'" % self.look_at_designator)
