...
def setup_statemachine(robot):
    ...
    with sm:
        ...
        smach.StateMachine.add('2QUESTION_1', indirect_speech_recognition.HearQuestion(robot), transitions={ 'answered' :'2LOOKUP_2', 'not_answered': '2TURN_1'})
        ...
        smach.StateMachine.add('2QUESTION_2', indirect_speech_recognition.HearQuestion(robot), transitions={ 'answered' :'2LOOKUP_3', 'not_answered': '2TURN_2'})
        ...
        smach.StateMachine.add('2QUESTION_3', indirect_speech_recognition.HearQuestion(robot), transitions={ 'answered' :'2LOOKUP_4', 'not_answered': '2TURN_3'})
        ...
        smach.StateMachine.add('2QUESTION_4', indirect_speech_recognition.HearQuestion(robot), transitions={ 'answered' :'2LOOKUP_5', 'not_answered': '2TURN_4'})
