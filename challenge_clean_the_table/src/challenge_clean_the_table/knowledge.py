...
ITEM_VECTOR_DICT = {
    "knife": PyKDL.Vector(-1.12, -0.08, 0),
    "fork": PyKDL.Vector(-1.12, -0.08, 0),
    "spoon": PyKDL.Vector(-1.12, -0.08, 0),
    "mug": PyKDL.Vector(-1.12, 0.13, -0.09),
    "plate": PyKDL.Vector(-1.12, -0.27, 0),
    "bowl": PyKDL.Vector(-1.12, 0.07, 0),
}
...
OPEN_DISHWASHER_VECTOR = PyKDL.Vector(-0.9625, -0.15, math.pi)
OPEN_DISHWASHER_VECTOR_AWAY = OPEN_DISHWASHER_VECTOR + PyKDL.Vector(-0.5, 0, 0)
...
JOINTS_OPEN_DISHWASHER4 = [0.7, -1.572, 0, -1.572, 0]
