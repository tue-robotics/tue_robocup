...
ITEM_VECTOR_DICT = {
    "knife": PyKDL.Vector(-1.12, 0.0, 0),
    "fork": PyKDL.Vector(-1.12, 0.0, 0),
    "spoon": PyKDL.Vector(-1.12, 0.0, 0),
    "mug": PyKDL.Vector(-1.12, 0.15, 0),
    "plate": PyKDL.Vector(-1.12, -0.27, 0),
    "bowl": PyKDL.Vector(-1.12, -0.1, 0),
}
...
OPEN_DISHWASHER_VECTOR = PyKDL.Vector(-0.97, -0.15, math.pi)
...
OPEN_DISHWASHER_VECTOR_OPEN5 = OPEN_DISHWASHER_VECTOR + PyKDL.Vector(0.1, 0, 0)
OPEN_DISHWASHER_VECTOR_OPEN6 = OPEN_DISHWASHER_VECTOR + PyKDL.Vector(-0.05, 0, 0)

PULL_DISHWASHER_RACK_PREPARE = OPEN_DISHWASHER_VECTOR_OPEN6 + PyKDL.Vector(0, -0.42, math.pi/2)
PULL_DISHWASHER_RACK_PREPARE_START = PULL_DISHWASHER_RACK_PREPARE + PyKDL.Vector(1.1, 0, 0)
PULL_DISHWASHER_RACK_OUT1 = PULL_DISHWASHER_RACK_PREPARE_START + PyKDL.Vector(0, 0, -0.34)
PULL_DISHWASHER_RACK_OUT2 = PULL_DISHWASHER_RACK_OUT1 + PyKDL.Vector(-0.51, 0, 0)
...
JOINTS_PLACE_PLATE = [0.39] + LAST_JOINTS_PLACE
JOINTS_PLACE_MUG_BOWL = [0.30] + LAST_JOINTS_PLACE
JOINTS_PLACE_CUTLERY = [0.29] + LAST_JOINTS_PLACE

JOINTS_RETRACT = [0.7, 0, 0, -1.572, 0]

JOINTS_OPEN_DISHWASHER_PRE = [0.37, -1.572, 0, 0.62, 1.572]
JOINTS_OPEN_DISHWASHER = [0.38, -1.572, 0, 0.61, 1.572]
