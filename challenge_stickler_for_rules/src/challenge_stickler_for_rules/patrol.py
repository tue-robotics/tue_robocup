    ...
    def __init__(self, robot_name, room_des):
        ...
        with self:
            ...
            smach.StateMachine.add(
                "CHECK_IN_FORBIDDEN_ROOM",
                CBState(check_forbidden_room),
                transitions={"yes": "NAVIGATE_TO_CHECK", "no": "done"},
            )
            smach.StateMachine.add(
                "NAVIGATE_TO_CHECK",
    ...
    def __init__(self, robot, room_des, speak=True):
        ...
        with self:
            smach.StateMachine.add(
                ...
                transitions={
                    "arrived": "CHECK_FORBIDDEN_ROOM",
                    "unreachable": "CHECK_FORBIDDEN_ROOM",
                    "goal_not_defined": "CHECK_FORBIDDEN_ROOM",
                },
            )

            smach.StateMachine.add(
                "CHECK_FORBIDDEN_ROOM",
